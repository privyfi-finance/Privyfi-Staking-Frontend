...
export default function LendPage() {
  ...
  const handleLend = async (amount: number) => {
    ...
    try {
      ...
      toast.success("Lending successfull!. Please claim in Miden wallet");
      setEthAmount("");
        ...
        <div className="p-6">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <button className="w-full bg-orange-500 hover:bg-orange-600 text-white py-3 rounded-lg font-medium" onClick={() => handleLend(Number(ethAmount))}>
